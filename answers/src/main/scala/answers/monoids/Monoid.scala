package answers.monoids

import answers.parallelism.Nonblocking._
import answers.parallelism.Nonblocking.Par.toParOps // infix syntax for `Par.map`, `Par.flatMap`, etc
